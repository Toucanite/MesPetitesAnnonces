...
{
  $y=0;
  $request = "SELECT * FROM tbl_ad as ad, tbl_user as us, `tbl_ad-cat` as ac, tbl_category as c WHERE ad.Id_User = us.Id_user AND ad.Id_Ad = ac.Tbl_Ad_Id_Ad AND ac.Tbl_Category_id_Category = c.id_Category ORDER BY ad.Dttm_Creation";
